var urlLink = "http://127.0.0.1:5500/javascript/Dynamic-grid/product.html?"
for(var x=0;x<10;x++){
    var idNum = x
    if(urlLink+idNum ===window.location.href){
       console.log("success");
       var i=x;
    }
}
...
productView.src= productList[i].preview
productView.style.width="100%"
 Productimages.appendChild(productView)

// *RIGHT SIDE SECTION*

{/* <h1 id="product-name"></h1>
<h4 id="product-brand"></h4>
<h3 id="product-price"><span id="price-details"></span></h3> */}
...
productBrand.innerText = productList[i].brand
productDetails.appendChild(productBrand);

var productPrice = document.getElementById('product-price')
var priceColor = document.getElementById('price-details')
productPrice.innerHTML = 'Price Rs: ';
priceColor.innerText = productList[i].price;
productPrice.appendChild(priceColor)
priceColor.style.color="#009688"
productDetails.appendChild(productPrice); 


{/* <div id="description">
<h3 id="descrition-heading"></h3>
 <p id="description-para"></p>
</div> */}

var description = document.getElementById('description')
var descriptionHeading = document.getElementById('descrition-heading')
descriptionHeading.innerHTML = "Description"
description.appendChild(descriptionHeading);
var descriptionPara = document.getElementById('description-para')
descriptionPara.innerText = productList[i].description
description.appendChild(descriptionPara);
productDetails.appendChild(description)


{/* <div id="product-preview">
<h3 id="product-preview-heading"></h3>
<div id="preview-image-container">
    <img id="img0" class="active">
    <img id="img1" class="active">
    <img id="img2" class="active">
    <img id="img3" class="active">
    <img id="img4" class="active">
</div>
</div> */}

var productPreview = document.getElementById('product-preview')

var productPreviewHeading = document.getElementById('product-preview-heading')
...
productPreview.appendChild(previewImageContainer)

var previewPicsArry = document.querySelectorAll('#preview-image-container img')
for(var n=0;n<previewPicsArry.length;n++){
    previewPicsArry[n].src = productList[i].photos[n]
    var reviewClick = previewPicsArry[n].src;
    
    // function my(){
    //     productView.src= productList[i].photos[n]
    // }
    // reviewClick.addEventListener("click",my())
}
var photo0 = document.getElementById('img0')
photo0.addEventListener("click",function(){
    productView.src = img0.src;
})
var photo1 = document.getElementById('img1')
photo1.addEventListener("click",function(){
    productView.src = img1.src;
})
var photo2 = document.getElementById('img2')
photo2.addEventListener("click",function(){
    productView.src = img2.src;
})
var photo3 = document.getElementById('img3')
photo3.addEventListener("click",function(){
    productView.src = img3.src;
})
var photo4 = document.getElementById('img4')
photo4.addEventListener("click",function(){
    productView.src = img4.src;
})


productDetails.appendChild(productPreview)

var buttn = document.getElementById('add-to-cart')
productDetails.appendChild(buttn)
